        ...
        <div className="varnika-container max-w-md mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground">
              Start your handmade gifting journey today
            </p>
          </div>

          <Card className="border-pastel-lavender/20 shadow-soft">
            <CardHeader>
              <CardTitle className="text-2xl font-display text-espresso">Create Account</CardTitle>
              <CardDescription>
                Sign up to start shopping handmade treasures
              </CardDescription>
            </CardHeader>
            <CardContent>
            ...
            <CardFooter className="flex justify-center">
              <p className="text-sm text-muted-foreground">
                ...
                <Link to="/login" className="text-pastel-pink hover:underline font-medium">
                  Sign in
                </Link>
              </p>
            </CardFooter>
