      ...
      <main className="pt-24 pb-16">
        <div className="varnika-container">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="font-display text-4xl md:text-6xl text-espresso mt-4 mb-6">
              All Masterpieces
            </h1>
            ...
            <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
              ...
              <div className="relative w-full md:w-96">
                ...
                <Input
                  ...
                  className="pl-12 h-12 border-border bg-card font-body"
                />
                {searchQuery && (
                  <button
                  ...
                  <article className="relative bg-card rounded-sm overflow-hidden shadow-soft hover:shadow-elevated transition-all duration-500 animate-fade-in">
                    ...
                    <div className="relative aspect-[3/4] overflow-hidden">
                      ...
                      <div className="absolute top-3 left-3 flex flex-col gap-2">
                        {art.salePrice && (
                          <span className="px-2 py-1 bg-terracotta text-cream text-xs tracking-wider uppercase rounded-sm">
                            Sale
                          </span>
                        )}
                        ...
                        {art.stock === 0 && (
                          <span className="px-2 py-1 bg-muted text-muted-foreground text-xs tracking-wider uppercase rounded-sm">
                            Sold Out
                          </span>
                        )}
                        {art.customizable && (
                          <span className="px-2 py-1 bg-gold/90 text-espresso text-xs tracking-wider uppercase rounded-sm">
                            Customizable
                          </span>
                        )}
                      </div>
          ...
          {!isLoading && filteredProducts.length === 0 && (
            <div className="text-center py-16">
              <p className="font-display text-2xl text-espresso mb-4">
                No pieces found
              </p>
